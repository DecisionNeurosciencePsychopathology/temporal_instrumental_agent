...
%fixed decay autocorrelation
fixed_decay_autocorrelation.init_params =  [prop_spread_init, .1, .6, .5, .5 ]; %prop_spread, alpha, gamma
fixed_decay_autocorrelation.lower_bounds = [prop_spread_bounds(1), lr_bounds(1), 0, 0.01, 0.01];
...
fixed_decay_autocorrelation.name = 'fixed_decay_autocorrelation'; %add explicit name parameter since each field in struct gets pulled out separately
...
fixed_decay_autocorrelation.fun = @(params) skeptic_fitsubject_all_models_all_runs_model_test([params(1) beta_init params(2) params(3) params(4) params(5)],...
