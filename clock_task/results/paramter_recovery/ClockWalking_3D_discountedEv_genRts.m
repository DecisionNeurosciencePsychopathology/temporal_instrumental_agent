function [maxReward, constr, quits,cumReward,mov, ret] = ClockWalking_3D_discountedEv_genRts(options,m,rngseeds,params,plot_index,gra_options)
...
%                     [~,ev_i(ei)] = RewFunction(nextpos.row.*factor, cond);
        ...
        %Do we want to add in randsample here???
