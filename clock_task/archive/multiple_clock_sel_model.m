...
tic
[fittedparameters_1,options]=simps('clock_selective_operator',[.05 .95 1],[1 2 3],[options],[0.001 0.9 0.01],[0.2 .99 10],fargs{:});
...
fittedparameters_2=simps('clock_selective_operator',[.1 .9 50],[1 2 3],[options],[0.001 0.9 0.01],[0.2 .9999 100],fargs{:});
...
fittedparameters_3=simps('clock_selective_operator',[.01 .99 10],[1 2 3],[options],[0.001 0.9 0.01],[0.2 .9999 100],fargs{:});
