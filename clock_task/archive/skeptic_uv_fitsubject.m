...
%%
function [cost,ret,mov] = skeptic_uv_fitsubject(params, rt_obs, rew_obs, rngseeds, nbasis, ntimesteps, trial_plots, cond, minrt, maxrt, modelname)
...
if nargin < 11, modelname='value_softmax'; end
