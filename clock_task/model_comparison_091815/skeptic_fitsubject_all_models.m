...
for i = 1:ntrials
    ...
    if strcmpi(modelname, 'fixed') || strcmpi(modelname, 'fixed_KL')
    ...
    if strcmpi(modelname, 'value_softmax') || strcmpi(modelname, 'v_processnoise') || strcmpi(modelname, 'fixed') || strcmpi(modelname, 'fixed_rho')
...
if trial_plots
    ...
    if strcmpi(modelname, 'value_softmax') || strcmpi(modelname, 'v_processnoise') || strcmpi(modelname, 'fixed') || strcmpi(modelname, 'fixed_KL') || strcmpi(modelname, 'v_process_noise_discounted') || strcmpi(modelname, 'fixed_rho')
        ...
        if strcmpi(modelname, 'value_softmax') || strcmpi(modelname, 'v_processnoise') || strcmpi(modelname, 'fixed') || strcmpi(modelname, 'v_process_noise_discounted') || strcmpi(modelname, 'fixed_rho')
